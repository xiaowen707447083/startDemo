...
+ (LocalDataManager *)sharedManager
{
    static LocalDataManager *sharedMyFMDataManagerInstance = nil;
    static dispatch_once_t predicate;
    dispatch_once(&predicate, ^{
        sharedMyFMDataManagerInstance = [[self alloc] init];
        
        //从文件资源中获取数据库
        NSString *dbPath = [[NSBundle mainBundle] pathForResource:@"cat_pingzhong" ofType:@"sqlite"];
        sharedMyFMDataManagerInstance.db = [FMDatabase databaseWithPath:dbPath];
    });
