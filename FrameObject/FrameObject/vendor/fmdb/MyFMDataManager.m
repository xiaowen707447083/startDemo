...
+ (MyFMDataManager *)sharedManager
{
    ...
    dispatch_once(&predicate, ^{
        ...
        sharedMyFMDataManagerInstance.db = [sharedMyFMDataManagerInstance createDataBase:nil];
...
+(void)changeDataBaseToStr:(NSString *)tar{
    ...
    static MyFMDataManager *sharedMyFMDataManagerInstance = nil;
    if (sharedMyFMDataManagerInstance != nil) {
        if ([tar isEqualToString:sharedMyFMDataManagerInstance.currentDataBaseTarg]) {
            //无效的切换
            return;
        }
        
        sharedMyFMDataManagerInstance = nil;
    }
    sharedMyFMDataManagerInstance = [[self alloc] init];
    sharedMyFMDataManagerInstance.db = [sharedMyFMDataManagerInstance createDataBase:tar];
    sharedMyFMDataManagerInstance.obj = [[NSObject alloc]init];
}
